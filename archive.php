...
<section
    ...
    data-setbg="<?php echo esc_url(get_template_directory_uri());?>/img/breadcrumb.jpg">
    <div class="container">
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="blog__item">
                            ...
                            <div class="blog__item__text">
                                <ul>
                                    <li>
                                        <i class="fa fa-calendar-o"></i><?php the_time('F j, Y');  ?></li>
                                    <li>
                                ...
                                <a href="<?php the_permalink(); ?>" class="blog__btn">READ MORE
                    ...
                    <div class="col-lg-12">
                        <div class="product__pagination blog__pagination">
                            ...
                            class="fa fa-long-arrow-left"></i>', 'next_text'=> '<i class="fa
